...
namespace AdminPureGold.WebUI.Classes.Account
{
    public class Membership : MembershipProvider
    {
        private readonly IWeichertCoreService _weichertCoreService;
        public Membership(IWeichertCoreService weichertCoreService)
        {
        ...
        {
            var user = _weichertCoreService.GetWeichertOneUserByCredentials(username, password);
            if (user != null)
            {
